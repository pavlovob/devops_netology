...
### Задание 7.
Команда bash 5>&1 создаст новый дескриптор с указанием на stdout (используется для сохранения потоков). команда echo netology > /proc/$$/fd/5 направит сообщение netology в созданный поток с дескриптором 5. Т.к. он ссылается на stdout (поток 1), по умолчанию сообщение будет выведено на экране 
### Задание 8.
### Задание 9.
### Задание 10.
### Задание 11.
